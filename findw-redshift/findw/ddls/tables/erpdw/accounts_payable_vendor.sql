CREATE TABLE IF NOT EXISTS erpdw.accounts_payable_supplier
(
 ...
 ,invoicepayaloneidentifier VARCHAR(30)
 ...
 ,UNIQUE (cycledate, batchid, source_system_name, sourcesystemsupplieridentifier, suppliersiteidentifier)
)
DISTSTYLE KEY
DISTKEY (sourcesystemsupplieridentifier)
SORTKEY (
