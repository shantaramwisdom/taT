...
target_data_temp as (
    select python_date_format_checker(transaction_date, 'YYYY') as transaction_date_chk,
           ...
           case
               when substr(gl_full_source_code, 1, 3) in ('903', '851', '444')
                    then nvl(d.reinsurance_assumed_ceded_flag, '0')
           end as reinsuranceassumedcededflag_drvd,
           decode(reinsuranceassumedcededflag_drvd, '0', 1, 0) as reinsuranceassumedcededflag_error_flag,
