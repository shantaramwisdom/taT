...
(
    ...
    *,
    ...
    (
        ...
        key_qualifier,
        company_code,
        coalesce(contract_fund_class_indicator_override, c_contract_fund_class_indicator, contract_fund_class_indicator) as contractoptionfundclassindicator,
        batchid,
        fund_number,
        row_number() over(partition by key_qualifier,
                                        company_code,
        ...
        from 
        {source_database}.gdqp5dprodsegmenteb_fund_information
        where 
