DROP TABLE IF EXISTS ${databasename}.lifepro1091ifrs17_general_ledger_line_item;

CREATE EXTERNAL TABLE ${databasename}.lifepro1091ifrs17_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/lifepro1091ifrs17/lifepro1091ifrs17_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.lifepro1091ifrs17_general_ledger_line_item SYNC PARTITIONS;
