DROP TABLE IF EXISTS ${databasename}.tagetik_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.tagetik_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/tagetik/tagetik_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.tagetik_general_ledger_line_item SYNC PARTITIONS;
