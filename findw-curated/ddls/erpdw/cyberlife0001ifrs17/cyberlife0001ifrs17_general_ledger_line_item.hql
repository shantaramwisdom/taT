DROP TABLE IF EXISTS ${databasename}.cyberlife0001ifrs17_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.cyberlife0001ifrs17_general_ledger_line_item
(
...
LOCATION
'${s3bucketname}/${projectname}/curated/erpdw/cyberlife0001ifrs17/cyberlife0001ifrs17_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.cyberlife0001ifrs17_general_ledger_line_item SYNC PARTITIONS;
