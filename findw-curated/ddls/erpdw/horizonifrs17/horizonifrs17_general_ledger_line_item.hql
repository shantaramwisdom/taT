DROP TABLE IF EXISTS ${databasename}.horizonifrs17_general_ledger_line_item;

CREATE EXTERNAL TABLE ${databasename}.horizonifrs17_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/horizonifrs17/horizonifrs17_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.horizonifrs17_general_ledger_line_item SYNC PARTITIONS;
