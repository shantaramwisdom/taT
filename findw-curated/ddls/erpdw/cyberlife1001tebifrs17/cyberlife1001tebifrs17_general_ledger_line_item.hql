DROP TABLE IF EXISTS ${databasename}.cyberlife1001tebifrs17_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.cyberlife1001tebifrs17_general_ledger_line_item
(
...
contactsourcemarketingorganizationcode string,
plancode string,
...
LOCATION
'${s3bucketname}/${projectname}/curated/erpdw/cyberlife1001tebifrs17/cyberlife1001tebifrs17_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.cyberlife1001tebifrs17_general_ledger_line_item SYNC PARTITIONS;
