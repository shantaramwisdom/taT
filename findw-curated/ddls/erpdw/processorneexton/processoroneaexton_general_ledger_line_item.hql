DROP TABLE IF EXISTS ${databasename}.processoroneaexton_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.processoroneaexton_general_ledger_line_item
(
 ...
 activitysourceclididentifier string,
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/processoroneaexton/processoroneaexton_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.processoroneaexton_general_ledger_line_item SYNC PARTITIONS;
