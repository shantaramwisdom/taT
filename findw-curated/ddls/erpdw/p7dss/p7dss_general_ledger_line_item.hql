DROP TABLE IF EXISTS ${databasename}.p7dss_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.p7dss_general_ledger_line_item
(
 ...
 -- IcnInputFlag string,
 -- ifrs17_fields_step_dsc string,
 -- ifrs17_cash_flow_step_dsc string,
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/p7dss/p7dss_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.p7dss_general_ledger_line_item SYNC PARTITIONS;
