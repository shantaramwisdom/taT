DROP TABLE IF EXISTS ${databasename}.vantagep65_general_ledger_line_item;

CREATE EXTERNAL TABLE ${databasename}.vantagep65_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/findw/vantagep65_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.vantagep65_general_ledger_line_item SYNC PARTITIONS;
