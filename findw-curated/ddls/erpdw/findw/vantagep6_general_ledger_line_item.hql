DROP TABLE IF EXISTS ${databasename}.vantagep6_general_ledger_line_item;

CREATE EXTERNAL TABLE ${databasename}.vantagep6_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/findw/vantagep6_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.vantagep6_general_ledger_line_item SYNC PARTITIONS;
