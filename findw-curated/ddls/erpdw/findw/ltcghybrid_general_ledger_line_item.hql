DROP TABLE IF EXISTS ${databasename}.ltcghybrid_general_ledger_line_item;

CREATE EXTERNAL TABLE ${databasename}.ltcghybrid_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/findw/ltcghybrid_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.ltcghybrid_general_ledger_line_item SYNC PARTITIONS;
