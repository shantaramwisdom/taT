DROP TABLE IF EXISTS ${databasename}.vantagep75_general_ledger_line_item;

CREATE EXTERNAL TABLE ${databasename}.vantagep75_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/findw/vantagep75_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.vantagep75_general_ledger_line_item SYNC PARTITIONS;
