DROP TABLE IF EXISTS ${databasename}.ltcg_general_ledger_line_item;

CREATE EXTERNAL TABLE ${databasename}.ltcg_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/findw/ltcg_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.ltcg_general_ledger_line_item SYNC PARTITIONS;
