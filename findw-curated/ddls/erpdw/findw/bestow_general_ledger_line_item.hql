DROP TABLE IF EXISTS ${databasename}.bestow_general_ledger_line_item;

CREATE EXTERNAL TABLE ${databasename}.bestow_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/findw/bestow_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.bestow_general_ledger_line_item SYNC PARTITIONS;
