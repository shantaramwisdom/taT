DROP TABLE IF EXISTS ${databasename}.tpapifrs17_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.tpapifrs17_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/tpapifrs17/tpapifrs17_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.tpapifrs17_general_ledger_line_item SYNC PARTITIONS;
