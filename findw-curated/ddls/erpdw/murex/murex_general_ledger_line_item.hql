DROP TABLE IF EXISTS ${databasename}.murex_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.murex_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/murex/murex_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.murex_general_ledger_line_item SYNC PARTITIONS;
