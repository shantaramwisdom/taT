DROP TABLE IF EXISTS ${databasename}.ahdfuturefirst_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.ahdfuturefirst_general_ledger_line_item
(
...
LOCATION
'${s3bucketname}/${projectname}/curated/erpdw/ahdfuturefirst/ahdfuturefirst_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.ahdfuturefirst_general_ledger_line_item SYNC PARTITIONS;
