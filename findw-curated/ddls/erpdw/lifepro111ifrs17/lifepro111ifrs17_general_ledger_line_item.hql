DROP TABLE IF EXISTS ${databasename}.lifepro111ifrs17_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.lifepro111ifrs17_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/lifepro111ifrs17/lifepro111ifrs17_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.lifepro111ifrs17_general_ledger_line_item SYNC PARTITIONS;
