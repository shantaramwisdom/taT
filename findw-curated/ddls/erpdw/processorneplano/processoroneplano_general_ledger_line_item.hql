DROP TABLE IF EXISTS ${databasename}.processoroneplano_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.processoroneplano_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/processoroneplano/processoroneplano_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.processoroneplano_general_ledger_line_item SYNC PARTITIONS;
