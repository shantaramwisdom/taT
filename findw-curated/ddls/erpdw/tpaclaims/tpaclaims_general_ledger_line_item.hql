DROP TABLE IF EXISTS ${databasename}.tpaclaims_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.tpaclaims_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/tpaclaims/tpaclaims_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.tpaclaims_general_ledger_line_item SYNC PARTITIONS;
