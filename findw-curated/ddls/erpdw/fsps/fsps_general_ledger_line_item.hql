DROP TABLE IF EXISTS ${databasename}.fsps_general_ledger_line_item;

CREATE EXTERNAL TABLE ${databasename}.fsps_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/fsps/fsps_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.fsps_general_ledger_line_item SYNC PARTITIONS;
