DROP TABLE IF EXISTS ${databasename}.p3dss_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.p3dss_general_ledger_line_item
(
 ...
 contractsourcexsystemname string,
 ...
 activitydebitsourcebatchidentifier string,
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/p3dss/p3dss_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.p3dss_general_ledger_line_item SYNC PARTITIONS;
