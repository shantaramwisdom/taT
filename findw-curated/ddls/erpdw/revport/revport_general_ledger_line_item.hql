DROP TABLE IF EXISTS ${databasename}.revport_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.revport_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/revport/revport_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.revport_general_ledger_line_item SYNC PARTITIONS;
