DROP TABLE IF EXISTS ${databasename}.ahd_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.ahd_general_ledger_line_item
(
...
LOCATION
'${s3bucketname}/${projectname}/curated/erpdw/ahd/ahd_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.ahd_general_ledger_line_item SYNC PARTITIONS;
