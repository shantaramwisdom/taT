DROP TABLE IF EXISTS ${databasename}.p5dss_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.p5dss_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/p5dss/p5dss_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.p5dss_general_ledger_line_item SYNC PARTITIONS;
