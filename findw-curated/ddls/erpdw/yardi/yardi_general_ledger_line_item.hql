DROP TABLE IF EXISTS ${databasename}.yardi_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.yardi_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/yardi/yardi_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.yardi_general_ledger_line_item SYNC PARTITIONS;
