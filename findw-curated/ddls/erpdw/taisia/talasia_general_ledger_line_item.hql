DROP TABLE IF EXISTS ${databasename}.talasia_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.talasia_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/talasia/talasia_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.talasia_general_ledger_line_item SYNC PARTITIONS;
