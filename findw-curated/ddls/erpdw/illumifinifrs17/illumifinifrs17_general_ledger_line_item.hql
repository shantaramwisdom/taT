DROP TABLE IF EXISTS ${databasename}.illumifinifrs17_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.illumifinifrs17_general_ledger_line_item
(
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/illumifinifrs17/illumifinifrs17_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.illumifinifrs17_general_ledger_line_item SYNC PARTITIONS;
