DROP TABLE IF EXISTS ${databasename}.lifecommifrs17_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.lifecommifrs17_general_ledger_line_item
(
 ...
 line_number int,
 activitydepositaccountbatchidentifier string,
 activitysourceoriginalinsuredid string,
...
LOCATION
 '${s3bucketname}/${projectname}/curated/erpdw/lifecommifrs17/lifecommifrs17_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.lifecommifrs17_general_ledger_line_item SYNC PARTITIONS;
