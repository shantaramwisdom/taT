DROP TABLE IF EXISTS ${databasename}.cyberlife9701ifrs17_general_ledger_line_item;
CREATE EXTERNAL TABLE ${databasename}.cyberlife9701ifrs17_general_ledger_line_item
(
...
LOCATION
'${s3bucketname}/${projectname}/curated/erpdw/cyberlife9701ifrs17/cyberlife9701ifrs17_general_ledger_line_item';
MSCK REPAIR TABLE ${databasename}.cyberlife9701ifrs17_general_ledger_line_item SYNC PARTITIONS;
