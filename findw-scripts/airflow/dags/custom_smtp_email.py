...
def build_mime_message(
    ...
    :param mime_subtype: The subtype of the MIME message. No validations are run on these
                         values, they should be able to be encoded.
    :param mime_charset: The charset of the email. Default: "utf-8".
    ...
    if not with_ssl:
        ...
        if ssl_context_string == "default":
            ...
            raise RuntimeError(
                ...
                f"be set to 'default' or 'none' and is {ssl_context_string!r}."
            )
